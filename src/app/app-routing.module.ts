...
import { ManageEmailsComponent } from './admin/components/manage-emails/manage-emails.component';
import { WeeklyComponent } from './admin/components/weekly/weekly.component';
import { UrgentComponent } from './admin/components/urgent/urgent.component';
import { AdminSettingsComponent } from './admin/components/admin-settings/admin-settings.component';
import { NotFoundComponent } from './not-found/not-found.component';
import { AdminNamesComponent } from './admin/components/admin-names/admin-names.component';
import { AdminSubmitNameComponent } from './admin/components/admin-submit-name/admin-submit-name.component';
import { AdminEditNameComponent } from './admin/components/admin-edit-name/admin-edit-name.component';
